...
import { PHASE_COMMIT, commitOnlyRecords, committedHash, listPaths, requireNextStep, requireNoStoppedLayerDone, requireRecordsCommittable, statePaths, uncommittedPaths, } from './shared.js';
...
function placedRootFiles(root) {
    const placed = ROOT_FILES.filter((file) => gitHeadEntry(root, file) === undefined && isPlacedRootFile(root, file));
